...
/*<div className="hs-content">
			<div className="container">
			    <div className="row">
				    <div className="isotope-grid" id="grid-2"></div>
                        <div className="entry col-xs-12 col-sm-4 col-md-3 filter-beverages">
                            <div className="entry-inner">
                                <div className="entry-media">
                                    <img src={strMealThumb} alt=""/>
                                    <div className="entry-action">
                                        <p>{strMeal}</p>
                                        <div className="entry-action-inner"><span><a href="recipe_single.html">VIEW RECIPE</a></span><span><a href="#">BOOKMARK RECIPE</a></span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
Instance of an object
{
    ...
    "strIngredient1":"Lentils","strIngredient2":"Onion",
    "strIngredient3":"Carrots","strIngredient4":"Tomato Puree",
    "strIngredient5":"Cumin","strIngredient6":"Paprika",
    "strIngredient7":"Mint",
